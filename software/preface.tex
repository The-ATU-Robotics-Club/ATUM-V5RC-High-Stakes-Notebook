...
\section{Iterations}
Since many parts of the code are so interlinked with each other and since there is rarely need for a massive overhaul of several files, you will see less clear iterations for any one component (say, the ladybrown) than you will for the entirety of the program. To this extend, in contrast to the hardware part of the notebook, you will find that the best place to find the iterations of the software is found in the logs, rather than any individual subsystem (though a summary of changes will be provided in said chapters). 